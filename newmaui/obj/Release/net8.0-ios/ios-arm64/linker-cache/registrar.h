...
@class OSDisplayableNotification;
@class OSInAppMessage;
@class OSInAppMessageClickEvent;
@protocol OSInAppMessageClickListener;
@class ApiDefinitions__Com_OneSignal_iOS_OSInAppMessageClickListener;
@class OSInAppMessageClickResult;
@class OSInAppMessageDidDismissEvent;
@class OSInAppMessageDidDisplayEvent;
@protocol OSInAppMessageLifecycleListener;
@class ApiDefinitions__Com_OneSignal_iOS_OSInAppMessageLifecycleListener;
@class OSInAppMessageOutcome;
@protocol OSInAppMessages;
@class OSInAppMessageTag;
@class OSInAppMessageWillDismissEvent;
@class OSInAppMessageWillDisplayEvent;
@protocol OSLiveActivities;
@protocol OSLocation;
@class OSNotificationClickEvent;
@protocol OSNotificationClickListener;
@class ApiDefinitions__Com_OneSignal_iOS_OSNotificationClickListener;
@class OSNotificationClickResult;
@protocol OSNotificationLifecycleListener;
@class ApiDefinitions__Com_OneSignal_iOS_OSNotificationLifecycleListener;
@protocol OSNotificationPermissionObserver;
@class ApiDefinitions__Com_OneSignal_iOS_OSNotificationPermissionObserver;
@protocol OSNotifications;
@class OSNotificationWillDisplayEvent;
@protocol _TtP13OneSignalUser18OSPushSubscription_;
@class _TtC13OneSignalUser30OSPushSubscriptionChangedState;
@protocol _TtP13OneSignalUser26OSPushSubscriptionObserver_;
@class ApiDefinitions__Com_OneSignal_iOS_OSPushSubscriptionObserver;
@class _TtC13OneSignalUser23OSPushSubscriptionState;
@protocol OSSession;
@protocol _TtP13OneSignalUser6OSUser_;
@class OneSignalSDK_DotNet_iOS_iOSInAppMessagesManager_InternalInAppMessageClickListener;
@class OneSignalSDK_DotNet_iOS_iOSInAppMessagesManager_InternalInAppMessageLifeCycleListener;
@class OneSignalSDK_DotNet_iOS_iOSNotificationsManager_InternalNotificationsPermissionObserver;
@class OneSignalSDK_DotNet_iOS_iOSNotificationsManager_InternalNotificationsLifecycleListener;
@class OneSignalSDK_DotNet_iOS_iOSNotificationsManager_InternalNotificationsClickListener;
@class OneSignalSDK_DotNet_iOS_iOSPushSubscription_InternalPushSubscriptionChangedHandler;
...
@protocol OSDebug
	@optional -(void) setLogLevel:(NSUInteger)p0;
	@optional -(void) setAlertLevel:(NSUInteger)p0;
@end
...
@protocol OSInAppMessageClickListener
	@optional -(void) onClickInAppMessage:(id)p0;
@end

@interface ApiDefinitions__Com_OneSignal_iOS_OSInAppMessageClickListener : NSObject<OSInAppMessageClickListener> {
}
	-(id) init;
@end
...
@interface OSInAppMessageClickResult : NSObject {
	...
	-(NSString *) actionId;
	-(void) setActionId:(NSString *)p0;
	-(BOOL) closingMessage;
	-(void) setClosingMessage:(BOOL)p0;
	-(NSDictionary *) jsonRepresentation;
	-(NSString *) url;
	-(void) setUrl:(NSString *)p0;
	-(NSUInteger) urlTarget;
	-(void) setUrlTarget:(NSUInteger)p0;
	-(id) init;
@end
...
@interface ApiDefinitions__Com_OneSignal_iOS_OSInAppMessageLifecycleListener : NSObject<OSInAppMessageLifecycleListener> {
}
	-(id) init;
@end
...
@protocol OSInAppMessages
	@optional @property (nonatomic, assign, readonly) BOOL paused;
	@optional -(void) addTrigger:(NSString *)p0 withValue:(NSString *)p1;
	@optional -(void) addTriggers:(NSDictionary <NSString *, NSString *>*)p0;
	@optional -(void) removeTrigger:(NSString *)p0;
	@optional -(void) removeTriggers:(NSArray *)p0;
	@optional -(void) clearTriggers;
	@optional -(void) paused:(BOOL)p0;
	@optional -(void) addClickListener:(id)p0;
	@optional -(void) removeClickListener:(id)p0;
	@optional -(void) addLifecycleListener:(id)p0;
	@optional -(void) removeLifecycleListener:(id)p0;
@end
...
@protocol OSLiveActivities
	@optional -(void) enter:(NSString *)p0 withToken:(NSString *)p1;
	@optional -(void) enter:(NSString *)p0 withToken:(NSString *)p1 withSuccess:(void (^)(id))p2 withFailure:(void (^)(id))p3;
	@optional -(void) exit:(NSString *)p0;
	@optional -(void) exit:(NSString *)p0 withSuccess:(void (^)(id))p1 withFailure:(void (^)(id))p2;
@end

@protocol OSLocation
	@optional @property (nonatomic, assign, readonly) BOOL isShared;
	@optional -(void) requestPermission;
	@optional -(void) setShared:(BOOL)p0;
@end
...
@protocol OSNotificationClickListener
	@optional -(void) onClickNotification:(id)p0;
@end

@interface ApiDefinitions__Com_OneSignal_iOS_OSNotificationClickListener : NSObject<OSNotificationClickListener> {
}
	-(id) init;
@end
...
@protocol OSNotificationLifecycleListener
	@optional -(void) onWillDisplayNotification:(id)p0;
@end

@interface ApiDefinitions__Com_OneSignal_iOS_OSNotificationLifecycleListener : NSObject<OSNotificationLifecycleListener> {
}
	-(id) init;
@end

@protocol OSNotificationPermissionObserver
	@optional -(void) onNotificationPermissionDidChange:(BOOL)p0;
@end

@interface ApiDefinitions__Com_OneSignal_iOS_OSNotificationPermissionObserver : NSObject<OSNotificationPermissionObserver> {
}
	-(id) init;
@end

@protocol OSNotifications
	@optional @property (nonatomic, assign, readonly) BOOL permission;
	@optional @property (nonatomic, assign, readonly) BOOL canRequestPermission;
	@optional @property (nonatomic, assign, readonly) NSInteger permissionNative;
	@optional -(void) addForegroundLifecycleListener:(id)p0;
	@optional -(void) removeForegroundLifecycleListener:(id)p0;
	@optional -(void) addClickListener:(id)p0;
	@optional -(void) removeClickListener:(id)p0;
	@optional -(void) requestPermission:(void (^)(BOOL))p0;
	@optional -(void) requestPermission:(void (^)(BOOL))p0 fallbackToSettings:(BOOL)p1;
	@optional -(void) registerForProvisionalAuthorization:(void (^)(BOOL))p0;
	@optional -(void) addPermissionObserver:(id)p0;
	@optional -(void) removePermissionObserver:(id)p0;
	@optional -(void) clearAll;
@end
...
@protocol _TtP13OneSignalUser18OSPushSubscription_
	...
	@optional @property (nonatomic, assign, readonly) NSString * token;
	@optional @property (nonatomic, assign, readonly) BOOL optedIn;
	@optional -(void) optIn;
	@optional -(void) optOut;
	@optional -(void) addObserver:(id)p0;
	@optional -(void) removeObserver:(id)p0;
@end

@interface _TtC13OneSignalUser30OSPushSubscriptionChangedState : NSObject {
}
	-(id) current;
...
@protocol _TtP13OneSignalUser26OSPushSubscriptionObserver_
	@optional -(void) onPushSubscriptionDidChangeWithState:(id)p0;
@end

@interface ApiDefinitions__Com_OneSignal_iOS_OSPushSubscriptionObserver : NSObject<_TtP13OneSignalUser26OSPushSubscriptionObserver_> {
}
	-(id) init;
@end

@interface _TtC13OneSignalUser23OSPushSubscriptionState : NSObject {
}
	-(NSString *) description;
	-(NSString *) id;
	-(NSDictionary *) jsonRepresentation;
...
@protocol OSSession
	@optional -(void) addOutcome:(NSString *)p0;
	@optional -(void) addUniqueOutcome:(NSString *)p0;
	@optional -(void) addOutcomeWithValue:(NSString *)p0 value:(NSNumber *)p1;
@end

@protocol _TtP13OneSignalUser6OSUser_
	@optional @property (nonatomic, retain, readonly) id pushSubscription;
	@optional -(void) addAliasWithLabel:(NSString *)p0 id:(NSString *)p1;
	@optional -(void) addAliases:(NSDictionary <NSString *, NSString *>*)p0;
	@optional -(void) removeAlias:(NSString *)p0;
	@optional -(void) removeAliases:(NSArray *)p0;
	@optional -(void) addTagWithKey:(NSString *)p0 value:(NSString *)p1;
	@optional -(void) addTags:(NSDictionary <NSString *, NSString *>*)p0;
	@optional -(void) removeTag:(NSString *)p0;
	@optional -(void) removeTags:(NSArray *)p0;
	@optional -(NSDictionary <NSString *, NSString *>*) getTags;
	@optional -(void) addEmail:(NSString *)p0;
	@optional -(void) removeEmail:(NSString *)p0;
	@optional -(void) addSms:(NSString *)p0;
	@optional -(void) removeSms:(NSString *)p0;
	@optional -(void) setLanguage:(NSString *)p0;
@end
