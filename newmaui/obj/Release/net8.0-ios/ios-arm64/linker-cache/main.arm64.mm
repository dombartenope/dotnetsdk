...
extern void *mono_aot_module_newmaui_info;
...
extern void *mono_aot_module_OneSignalSDK_DotNet_Core_info;
extern void *mono_aot_module_OneSignalSDK_DotNet_info;
extern void *mono_aot_module_OneSignalSDK_DotNet_iOS_Binding_info;
extern void *mono_aot_module_OneSignalSDK_DotNet_iOS_info;
...
void xamarin_register_modules_impl ()
{
	...
	mono_aot_register_module (mono_aot_module_newmaui_info);
	...
	mono_aot_register_module (mono_aot_module_OneSignalSDK_DotNet_Core_info);
	mono_aot_register_module (mono_aot_module_OneSignalSDK_DotNet_info);
	mono_aot_register_module (mono_aot_module_OneSignalSDK_DotNet_iOS_Binding_info);
	mono_aot_register_module (mono_aot_module_OneSignalSDK_DotNet_iOS_info);
...
void xamarin_register_assemblies_impl ()
{
	...
	xamarin_process_managed_exception_gchandle (exception_gchandle);
	xamarin_open_and_register ("OneSignalSDK.DotNet.iOS.Binding.dll", &exception_gchandle);
	xamarin_process_managed_exception_gchandle (exception_gchandle);
...
void xamarin_setup_impl ()
{
	...
	xamarin_executable_name = "newmaui.dll";
	mono_use_llvm = TRUE;
	xamarin_log_level = 0;
